...
> **TL;DR**: Large Language Models are neural networks trained on trillions of tokens that predict the next word in a sequence, enabling them to understand context, generate human-like text, and perform complex reasoning tasks through the Transformer architecture's self-attention mechanism.
...
│                                                               │
│   Layer 1:  Self-Attention → Feed-Forward → Add & Norm        │
│   Layer 2:  Self-Attention → Feed-Forward → Add & Norm        │
│   ...                                                         │
│   Layer N:  Self-Attention → Feed-Forward → Add & Norm        │
│                                                               │
│   Self-Attention: Learns "is" refers to "capital of France"   │
│   Feed-Forward:   Refines representations with learned facts   │
└───────────────────────┬───────────────────────────────────────┘
                        │
                        ▼
┌───────────────────────────────────────────────────────────────┐
...
│                                                               │
│   Probability distribution over vocabulary (50k-200k tokens): │
...
│                   "Paris"                                     │
│                                                               │
│   (Feed back as input to generate next token)                 │
└───────────────────────────────────────────────────────────────┘
```
