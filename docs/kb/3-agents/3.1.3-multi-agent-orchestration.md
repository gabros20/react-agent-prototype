...
class MCPAgent {
	constructor(public name: string, private channel: MCPChannel) {
...
_Source: Multi-agent benchmark suite (Klizos 2025)_
...
_Supervision overhead increases with agent count_
