...
- [2.2.3 Context Pruning](./2.2.3-context-pruning.md) - Complementary context reduction
- [2.2.5 Prompt Caching](./2.2.5-prompt-caching.md) - Provider-level caching strategies
