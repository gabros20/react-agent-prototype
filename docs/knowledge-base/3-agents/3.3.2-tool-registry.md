...
> **Grounded In**: MCP protocol, enterprise AI agent patterns
...
• No governance → Who owns deletePage?
...
│  │               Tool Definitions                   │       │
│  │  • getPage        • sendEmail                   │       │
│  │  • createPage     • searchQuery                 │       │
│  │  • updatePage     • queryDatabase               │       │
│  └─────────────────────────────────────────────────┘       │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
toolRegistry.register({
  ...
  needsApproval: false,
  description: 'Retrieves CMS page by ID or slug',
  documentation: 'https://docs.example.com/tools/getPage',
  examples: [
    {
  ...
  inputSchema: getPage.inputSchema,
  execute: getPage.execute,
});
```
...
describe('ToolRegistry', () => {
  ...
  it('excludes deprecated tools from getAll', () => {
    registry.register({ ...baseTool, id: 'active', status: 'active', category: ToolCategory.UTILITY });
    registry.register({ ...baseTool, id: 'deprecated', status: 'deprecated', category: ToolCategory.UTILITY });
...
**Academic Papers**
- Liangjun Jiang - "AI Agent Discovery Tool: How Do You Build It?" (Sep 2025) - [medium.com](https://liangjunjiang.medium.com/ai-agent-discovery-tool-how-do-you-build-it)
- Collibra - "AI Agent Registry: Governing Autonomous AI Agents" (Oct 2025) - [collibra.com](https://www.collibra.com/blog/collibra-ai-agent-registry-governing-autonomous-ai-agents)

**Framework Documentation**
- Anthropic - "Model Context Protocol" (2024-2025) - [modelcontextprotocol.io](https://modelcontextprotocol.io/)
- Solo.io - "AgentRegistry: Open-source tool for AI agent discovery" (Nov 2025) - [zdnet.com](https://www.zdnet.com/article/struggling-to-track-ai-agents-this-open-source-tool)

**Industry Resources**
- Forgen.ai - "The 2025 AI Agent Landscape" (Jul 2025) - [forgen.ai](https://blog.forgen.ai/the-2025-ai-agent-landscape-platforms-frameworks-and-registries)
