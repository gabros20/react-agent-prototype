...
> **Grounded In**: AI SDK v6 `experimental_context`, dependency injection patterns
...
**Academic Papers**
- AG2 Documentation - "Chat Context Dependency Injection" (Apr 2025) - [docs.ag2.ai](https://docs.ag2.ai/0.8.5/docs/use-cases/notebooks/notebooks/tools_chat_context)

**Framework Documentation**
- AI SDK v6 - "Tools and Tool Calling" (2025) - [v6.ai-sdk.dev](https://v6.ai-sdk.dev/docs/ai-sdk-core/tools-and-tool-calling)
- Anthropic - "Model Context Protocol (MCP)" (2024-2025) - [modelcontextprotocol.io](https://modelcontextprotocol.io/)

**Industry Resources**
- MintMCP - "Vercel AI SDK with MCP: Connect Multiple AI Models" (Oct 2025) - [mintmcp.com](https://www.mintmcp.com/blog/connect-multiple-ai-models)
- GitHub Issue - "Allow experimental_context in client-side tools" (Oct 2025) - [github.com/vercel/ai](https://github.com/vercel/ai/issues/9214)
