...
> **Prerequisites**: [2.1 Prompt Engineering Fundamentals](../2-prompting/2.1-prompt-engineering.md)
> **Grounded In**: AI SDK v6 documentation, production tool design patterns
...
### Basic Tool Definition (AI SDK v6)
    ...
    try {
      ...
      if (!page) {
        return {
          ...
          identifier,
          suggestion: 'Check the page ID/slug or list available pages',
        };
      }
...
describe('getPage', () => {
  ...
  it('returns page when found', async () => {
    ...
    const result = await getPage.execute(
...
it('validates input schema', () => {
  const schema = getPage.inputSchema;
...
**Academic Papers**
- Scalifiai - "Best Practices for Function Calling in LLMs" (Oct 2025) - [scalifiai.com](https://www.scalifiai.com/blog/function-calling-tool-call-best%20practices)
- QuotientAI - "Evaluating Tool Calling Capabilities in LLMs" (May 2025) - [quotientai.co](https://blog.quotientai.co/evaluating-tool-calling-capabilities-in-large-language-models)

**Framework Documentation**
- AI SDK v6 - "Tools and Tool Calling" (2025) - [v6.ai-sdk.dev](https://v6.ai-sdk.dev/docs/ai-sdk-core/tools-and-tool-calling)
- OpenAI - "Function Calling Best Practices" (2024) - [community.openai.com](https://community.openai.com/t/best-practices-for-improving-assistants-function-calling-reasoning)

**Industry Resources**
- CodeWithCaptain - "LLM Function Calling Best Practices" (Nov 2025) - [codewithcaptain.com](https://codewithcaptain.com/llm-function-calling-best-practices/)
